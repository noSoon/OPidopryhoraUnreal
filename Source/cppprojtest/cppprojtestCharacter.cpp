...
//////////////////////////////////////////////////////////////////////////
// AcppprojtestCharacter

AcppprojtestCharacter::AcppprojtestCharacter()
{
...
void AcppprojtestCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AcppprojtestCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AcppprojtestCharacter::Look);
	}
	else
	{
...
void AcppprojtestCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AcppprojtestCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
